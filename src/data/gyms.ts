...
const SPECS: Spec[] = [
  // ============================ BANGKOK ============================
  {
    ...
    level: "advanced", fighters: true, accom: false, price: "$", priceNote: "~350 THB/session (placeholder)",
    ...
    trainers: [{ name: "Kru (placeholder)", note: "Ex-stadium fighter" }],
  },
  {
    id: "kaewsamrit", name: "Kaewsamrit Gym", city: "bangkok",
    lat: 13.69, lng: 100.49, rating: 4.7, reviews: 180,
    level: "advanced", fighters: true, accom: false, price: "$", priceNote: "~400 THB/session (placeholder)",
  ...
  },
  {
    ...
    level: "mixed", fighters: true, accom: false, price: "$$", priceNote: "~500 THB/session (placeholder)",
  ...
  },
  {
    ...
    level: "beginner", fighters: false, accom: false, price: "$$", priceNote: "estimate (placeholder)",
  ...
  },
  {
    ...
    trainers: [{ name: "Coach Dam Srichan" }],
  },
  ...
  // ============================ PHUKET ============================
  {
    ...
    level: "mixed", fighters: true, accom: true, price: "$$", priceNote: "~500 THB/session, packages (placeholder)",
  ...
  },
  {
    ...
    level: "mixed", fighters: true, accom: true, price: "$$", priceNote: "~450 THB/session (placeholder)",
  ...
  },
  {
    ...
    level: "mixed", fighters: true, accom: true, price: "$$$", priceNote: "premium packages with stay (placeholder)",
  ...
  },
  {
    ...
    level: "beginner", fighters: false, accom: true, price: "$$", priceNote: "~400 THB/session (placeholder)",
  ...
  },
  {
    ...
    level: "mixed", fighters: true, accom: true, price: "$$$", priceNote: "premium packages (placeholder)",
